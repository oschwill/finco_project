        ...
        <div className="flex justify-center gap-5 w-full">
          <div className="flex flex-col gap-2 bg-[#f7f7f7] p-5 rounded-xl w-full">
            <div className="relative w-[100px] h-[100px]">
              <Image src="/img/home/income.svg" alt="income icon" fill className="object-cover" />
            </div>

            <p className="text-[1.5rem] font-light">Income</p>
            <p className="text-[2.5rem] font-bold">+ $10.000</p>
          </div>
          <div className="flex flex-col gap-2 bg-[#f7f7f7] p-5 rounded-xl w-full">
            <div className="relative w-[100px] h-[100px]">
              <Image src="/img/home/expense.svg" alt="income icon" fill className="object-cover" />
            </div>

            <p className="text-[1.5rem] font-light">Expense</p>
            <p className="text-[2.5rem] font-bold">- $10.000</p>
          </div>
        </div>
